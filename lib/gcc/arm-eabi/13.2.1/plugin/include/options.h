...
enum opt_code
{
  ...
  OPT_Wuninit_variable_checking = 834,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 835,      /* -Wuninit-variable-checking= */
  ...
  OPT_list = 1886,                           /* -list */
  OPT_mabi_ = 1887,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1888,             /* -mabort-on-noreturn */
  OPT_mapcs = 1889,                          /* -mapcs */
  OPT_mapcs_frame = 1890,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1891,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1892,              /* -mapcs-stack-check */
  OPT_march_ = 1893,                         /* -march= */
  OPT_marm = 1894,                           /* -marm */
  OPT_masm_syntax_unified = 1895,            /* -masm-syntax-unified */
  OPT_mbe32 = 1896,                          /* -mbe32 */
  OPT_mbe8 = 1897,                           /* -mbe8 */
  OPT_mbig_endian = 1898,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1899,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 1900,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 1901,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1902,     /* -mcaller-super-interworking */
  OPT_mcmse = 1903,                          /* -mcmse */
  OPT_mcpu_ = 1904,                          /* -mcpu= */
  OPT_mfdpic = 1905,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1906,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1907,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1908, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1909,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1910,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1911,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1912,                  /* -mfp16-format= */
  OPT_mfpu_ = 1913,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1914,             /* -mgeneral-regs-only */
  ...
  OPT_mneon_for_64bits = 1919,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1920,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1921,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1922,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1923,               /* -mprint-tune-info */
  OPT_mpure_code = 1924,                     /* -mpure-code */
  OPT_mrestrict_it = 1925,                   /* -mrestrict-it */
  OPT_msched_prolog = 1926,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1927,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1928,               /* -mslow-flash-data */
  ...
  OPT_mstructure_size_boundary_ = 1932,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1933,                         /* -mthumb */
  OPT_mthumb_interwork = 1934,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1935,                  /* -mtls-dialect= */
  OPT_mtp_ = 1936,                           /* -mtp= */
  OPT_mtpcs_frame = 1937,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1938,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1939,                         /* -mtune= */
  OPT_munaligned_access = 1940,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1941,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1942,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1943,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1944,              /* -mword-relocations */
  OPT_n = 1945,                              /* -n */
  OPT_name_sort = 1946,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1947,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1948,              /* -no-integrated-cpp */
  OPT_no_pie = 1949,                         /* -no-pie */
  OPT_nocpp = 1950,                          /* -nocpp */
  OPT_nodefaultlibs = 1951,                  /* -nodefaultlibs */
  OPT_nolibc = 1952,                         /* -nolibc */
  OPT_nophoboslib = 1953,                    /* -nophoboslib */
  OPT_nostartfiles = 1954,                   /* -nostartfiles */
  OPT_nostdinc = 1955,                       /* -nostdinc */
  OPT_nostdinc__ = 1956,                     /* -nostdinc++ */
  OPT_nostdlib = 1957,                       /* -nostdlib */
  OPT_nostdlib__ = 1958,                     /* -nostdlib++ */
  OPT_o = 1959,                              /* -o */
  OPT_objects = 1960,                        /* -objects */
  OPT_p = 1961,                              /* -p */
  OPT_pass_exit_codes = 1962,                /* -pass-exit-codes */
  /* OPT_pedantic = 1963, */                 /* -pedantic */
  OPT_pedantic_errors = 1964,                /* -pedantic-errors */
  OPT_pg = 1965,                             /* -pg */
  OPT_pie = 1966,                            /* -pie */
  OPT_pipe = 1967,                           /* -pipe */
  OPT_print_file_name_ = 1968,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1969,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1970,          /* -print-multi-directory */
  OPT_print_multi_lib = 1971,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1972,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1973,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1974,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1975,               /* -print-prog-name= */
  OPT_print_search_dirs = 1976,              /* -print-search-dirs */
  OPT_print_sysroot = 1977,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1978,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1979,                    /* -print-value */
  OPT_quiet = 1980,                          /* -quiet */
  OPT_r = 1981,                              /* -r */
  ...
  /* OPT_std_c__2a = 2018, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2019, */                /* -std=c++2b */
  ...
  /* OPT_std_gnu__2a = 2045, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2046, */              /* -std=gnu++2b */
